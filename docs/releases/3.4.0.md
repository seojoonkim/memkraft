...
MemKraft 3.4.0 consolidates the completed but previously unpublished execution and governance work onto one release baseline.

The unpublished 3.3 candidate is absorbed into 3.4.0; there is no separately shipped 3.3 release line.
